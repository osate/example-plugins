 ...
 */
public class ScriptHandler2 extends AbstractHandler {
	public static final String SCRIPT = "modelstatistics2.py";
	@Override
	public final Object execute(final ExecutionEvent event) throws ExecutionException {
		IWorkbenchWindow window = HandlerUtil.getActiveWorkbenchWindowChecked(event);
		String scriptURL = "platform:/plugin/org.osate.runscript/scripts/modelstatistics2.py";
		try {
			...
			if (selection instanceof IStructuredSelection) {
				...
				URI uri = org.eclipse.emf.common.util.URI
						.createPlatformResourceURI(((IFile) selected).getFullPath().toString(), true);
			...
			Object result = runPythonScript(scriptURL, systemInstance);
	...
	Object runPythonScript(String scriptURL, SystemInstance systemInstance) throws ExecutionException {
		try {
			...
			if (engineDescription != null) {
				...
				Object[] argv = new Object[] { SCRIPT, systemInstance };
				...
				engine.schedule();
				final Object result = scriptResult.get(10, TimeUnit.SECONDS);
